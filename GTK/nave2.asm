...
loop_colisoes:
	...
	cmp r3,r4
	jgr return_verifica_colisoes
	
	add r1,r1,r3 ;r1=pos_alien[r3]
	loadi r1,r1
	inc r3
	...
	cmp r0, r1
	jne return_verifica_colisoes

return_verifica_colisoes:
	pop r4
	pop r3
	pop r2
	pop r1
...
apaga_alien_pego:
	...
	cmp r1, r2
	jeq return_apaga_alien_pego
	
	loadn r2, #pos_ant_alien
	add r2,r2,r3	;posiciona para escrita futura da nova posicao
	
	loadn r3,#40
	add r4,r0,r1 ; endereço + pos anterior do alien
	div r5,r1,r3 ; correção de \0
	add r4,r4,r5 ; r4=endereco[pos_ant_alien] + correção \0
	
	loadi r4,r4 ;carrega valor da nova posicao
	
	outchar r4, r1
	
	storei r2, r4 ;guarda posicao atual na posicao antiga

return_apaga_alien_pego:
	pop r4
	pop r3
	pop r2
	pop r1
...
loop_apaga:	
	...
	cmp r6, r7
	jgr return_apaga_aliens
	
	add r1,r1,r6 ;r1=pos_ant_alien[r6]
	add r2,r2,r6 ;r2=pos_alien[r6]
...
recalcula_aliens:
	...
	loadn r1, #40 ;valor para descer vertical
	loadn r2, #0 ;contador
	load r3, num_alien
loop_rec_aliens:
	cmp r2,r3
	...
	loadn r0, #pos_alien
	add r0,r0,r2 ;r0=pos_alien + r2
	
	inc r2
	
	loadi r3,r0 ;r3=pos_alien[r2]
	add r3,r3,r1 ;pos_alien[r2]+=40 (faz alien descer)
	
	storei r3, r0 ;pos_alien[r2]=r3
